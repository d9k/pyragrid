...
class ViewsPaymentClientYandexMoney:
    def __init__(self, request):
        # TODO """:type self.request """
        self.request = request

    @view_config(renderer='json')
    def view_result_redirect(self):
        # self.request.
        ...
        # payment_client_test = PaymentClientYandexMoney()
...
class PaymentClientYandexMoney (AbstractPaymentClient):
    caption = 'Yandex money'
    test_field = 0000
    route_result_redirect = 'paymentApi/yandexMoneyResultRedirect'
    app_id = None
    ...
    def on_class_load(cls, config: pyramid.config.Configurator):
        ...
        config.add_route('yandex_money_result_redirect', cls.route_result_redirect)
