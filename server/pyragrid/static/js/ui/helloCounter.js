...
var HelloCounter = function (_React$Component2) {
  _inherits(HelloCounter, _React$Component2);

  function HelloCounter(props) {
    _classCallCheck(this, HelloCounter);

    return _possibleConstructorReturn(this, (HelloCounter.__proto__ || Object.getPrototypeOf(HelloCounter)).call(this, props));
  }

  _createClass(HelloCounter, [{
    key: "render",
    value: function render() {
